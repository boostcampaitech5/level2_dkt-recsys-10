...
from data_generator import Riiid_Sequence2
import os
import pandas as pd
...
def main():
    ...
    with open("./after_data/test_group90.pkl.zip", 'rb') as pick:
    ...
    checkpoint = torch.load('./model/fianlSaint+.pt', map_location=device)
...
if __name__ == "__main__":
    ...
    submission3.to_csv("./output/submissionSatin.csv", index=False)