...
class SaintPlus(nn.Module):
    def __init__(self, seq_len, num_layers, d_ffn, d_model, num_heads, max_len, n_questions, n_tasks,dropout):
        ...
        self.emb_dense2 = nn.Linear(5*d_model, d_model) # 5
    ...
    def forward(self, content_ids, time_lag, ques_elapsed_time, item_aver,user_aver, answer_correct): # , user_aver
        ...
        decoder_val = torch.cat((time_lag, elapsed_time, item_aver,user_aver,answer_correct_emb), axis=-1) #  user_aver,
